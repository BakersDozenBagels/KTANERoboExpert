...
public class WireSequence : RoboExpertModule
{
    ...
    public override Grammar Grammar => _grammar ??= new(new Choices(new GrammarBuilder(new Choices("red", "blue", "black").ToGrammarBuilder().Then(new("to", 0, 1)).Then(new Choices(NATO.Take(3).ToArray())), 1, 3), "undo", "redo", "reset"));
